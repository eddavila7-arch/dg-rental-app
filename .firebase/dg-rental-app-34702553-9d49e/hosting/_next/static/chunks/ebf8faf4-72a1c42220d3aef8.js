"use strict";(self.webpackChunk_N_E=self.webpackChunk_N_E||[]).push([[117],{4968:function(e,t,n){n.d(t,{p:function(){return nc}});var i,r=n(7683),s=n(2345),a=n(4419),o=n(3313);function l(){return{"dependent-sdk-initialized-before-auth":"Another Firebase SDK was initialized and is trying to use Auth before Auth is initialized. Please be sure to call `initializeAuth` or `getAuth` before starting any other Firebase SDK."}}let c=new s.LL("auth","Firebase",l()),u=new a.Yd("@firebase/auth");function h(e){for(var t=arguments.length,n=Array(t>1?t-1:0),i=1;i<t;i++)n[i-1]=arguments[i];u.logLevel<=a.in.ERROR&&u.error("Auth (".concat(r.Jn,"): ").concat(e),...n)}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e9(e,t){let n=arguments.length>2&&void 0!==arguments[2]&&arguments[2],{auth:i}=e;if((0,r.rh)(i.app))return Promise.reject(m(i));let s="reauthenticate";try{let r=await K(e,e6(i,s,t,e),n);v(r.idToken,i,"internal-error");let a=j(r.idToken);v(a,i,"internal-error");let{sub:o}=a;return v(e.uid===o,i,"user-mismatch"),e2._forOperation(e,s,r)}catch(e){throw(null==e?void 0:e.code)==="auth/user-not-found"&&d(i,"user-mismatch"),e}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function e8(e,t){let n=arguments.length>2&&void 0!==arguments[2]&&arguments[2];if((0,r.rh)(e.app))return Promise.reject(m(e));let i="signIn",s=await e6(e,i,t),a=await e2._fromIdTokenResponse(e,i,s);return n||await e._updateCurrentUser(a.user),a}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
